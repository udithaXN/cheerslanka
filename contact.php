<?php $head_title = "Cheers lanka travels - Experience Paradise, One Journey at a Time - Contact" ?>
                    ...
                    <div class="col-md-6">
                        <div class="contact-info-item" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50" data-aos-delay="100">
                            ...
                            <div class="content">
                                ...
                                <div class="text"><i class="far fa-phone"></i> <a href="callto:+94 76 424 8437">+94 76 424 8437</a></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="contact-info-item" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50" data-aos-delay="50">
                            ...
                            <div class="content">
                                <h5>Address</h5>
                                <div class="text"><i class="fal fa-map-marker-alt"></i> Janaka gamage, No.88/1, Mederipitiya, deniyaya.</div>
                            </div>
                        </div>
                    </div>
