                        ...
                        <div class="row mt-35">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="fromLocation" class="form-control" placeholder="From Location" required data-error="Please enter the From Location">
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="toLocation" class="form-control" placeholder="To Location" required data-error="Please enter the To Location">
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="country" class="form-control" placeholder="Your Country" required data-error="Please enter your Country">
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="nationality" class="form-control" placeholder="Your Nationality" required data-error="Please enter your Nationality">
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                            <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group mb-0">
                                    <button id="submitButton" class="theme-btn style-two" onclick="sendTForm();">
